    ...
    <header className="fixed top-0 left-0 right-0 h-20 bg-stone-50/90 backdrop-blur-md border-b border-stone-200 z-40 flex items-center justify-between px-8 pl-[104px] transition-all duration-300">
      ...
      <div className="relative" ref={dropdownRef}>
        <button 
          ...
          className="flex items-center gap-3 bg-white border border-stone-200 pl-4 pr-2 py-1.5 rounded-full shadow-sm hover:shadow-md hover:border-stone-300 transition-all duration-200 group focus:outline-none focus:ring-2 focus:ring-[#A67B5B]/50"
        >
          <div className="flex flex-col text-right mr-1">
            <span className="text-sm font-bold text-stone-900 leading-tight group-hover:text-[#A67B5B] transition-colors">{usuario.nome}</span>
        ...
        {isDropdownOpen && (
          <div className="absolute right-0 mt-3 w-64 bg-white rounded-2xl shadow-2xl border border-stone-100 py-2 animate-in fade-in slide-in-from-top-4 duration-200 z-50">
            <div className="px-4 py-3 border-b border-stone-100 mb-2">
              ...
              <p className="text-xs text-stone-500 truncate">jean@baply.com</p>
            </div>
